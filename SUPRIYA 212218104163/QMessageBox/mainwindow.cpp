...
{
QMessageBox::information(this,"Supriya 212218104163","This Is Information Box");

}

void MainWindow::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply= QMessageBox::question(this,"Supriya","Do You Like Apples",QMessageBox::Yes|QMessageBox::No);
...
{
    QMessageBox::StandardButton reply= QMessageBox::question(this," Supriya","this is a custom message",QMessageBox::Yes|QMessageBox::No|QMessageBox::YesAll|QMessageBox::NoAll);
    if(reply==QMessageBox::Yes)
